(function (root, factory) {
  ...
  var data = {
    ...
    'syntax-errors': {
      ...
      'lambda_formals_variable_expected': 'Очаква се поне една променлива в списъка от формални параметри.',
      ...
      'no_begin_exprs': 'Изразът "почни" трябва да съдържа поне един подизраз.',
